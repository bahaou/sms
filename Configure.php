...
use OCA\TwoFactorGateway\Service\Gateway\SMS\Provider\slneeConfig;
...
class Configure extends Command {
	...
	private function configureSms(InputInterface $input, OutputInterface $output) {
		...
		$providerQuestion = new Question('Please choose a SMS provider (websms, playsms, clockworksms, puzzelsms, ecallsms, voipms, voipbuster, huawei_e3531, spryng, sms77io, ovh, clickatellcentral, clicksend,slnee): ', 'websms');
		...
		switch ($provider) {
			case 'slnee':
				...
				/** @var SlneeConfig $providerConfig */
				$providerConfig = $config->getProvider()->getConfig();
				$appcodeQuestion = new Question('Please enter your Appcode: ');
				$appcode = $helper->ask($input, $output, $appcodeQuestion);
				$providerConfig->setAppcode($appcode);
				break;
